...
PCC3OBJ = main.o message.o symtab.o types.o bucket.o utils.o tree.o gram.o scan.o $(BACKEND).o
...
# Custom modules here (tree and encode)
tree.o: tree.c defs.h tree.h
